    ...
    <div class="chat-header">
        <div class="chat-user">
            <div class="chat-user-photo">
                <img src="https://img.freepik.com/icones-gratis/do-utilizador_318-563642.jpg?w=360" alt="Rafael Vieira">
            </div>

            <p class="chat-user-name">Rafael Vieira</p>
        </div>
    ...
    <div class="chat-footer">
        <form action="?" method="POST" class="chat-form">
            <div class="chat-form-input">
                <input type="text" id="message" name="message" placeholder="Sua mensagem">

                <button type="button" title="Attach" class="chat-form-attach" data-more-actions="button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-paperclip" viewBox="0 0 16 16">
                        <path d="M4.5 3a2.5 2.5 0 0 1 5 0v9a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 1 1 0v7a.5.5 0 0 0 1 0V3a1.5 1.5 0 1 0-3 0v9a2.5 2.5 0 0 0 5 0V5a.5.5 0 0 1 1 0v7a3.5 3.5 0 1 1-7 0V3z"/>
                    </svg>
                </button>

                <div class="chat-form-attach-more" id="more-actions">
            ...
            <button type="button" title="Send" class="chat-form-submit">
